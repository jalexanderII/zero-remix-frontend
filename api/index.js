...
function PaymentPlanCreation() {
  let { totalAmount, frequency, timeline, planType, accountInfo, reset } = usePaymentPlanCreationForm((state) => state), { accountAndTransactions, email } = (0, import_react26.useLoaderData)();
