// To parse this data:
//
//   import { PaymentPlanConvert, PaymentPlanRequest } from "./file";
//
...
import { a, cast, o, r, uncast } from "~/utils/json_converter_helpers";
...
export class PaymentPlanConvert {
  public static toPaymentPlanRequest(json: string): PaymentPlanRequest {
    return cast(JSON.parse(json), r("PaymentPlanRequest"), typeMap);
  }
